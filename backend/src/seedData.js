...
const moods = [
    ...
    { moodId: 'mood_010', name: 'Peaceful', description: 'Friedliche, harmonische Klänge', keywords: ['serene', 'tranquil', 'harmonious'], createdAt: new Date() },
    { moodId: 'mood_011', name: 'Intense', description: 'Intensive, packende Musik', keywords: ['gripping', 'forceful', 'compelling'], createdAt: new Date() },
    { moodId: 'mood_012', name: 'Dreamy', description: 'Verträumte, ätherische Klänge', keywords: ['ethereal', 'floating', 'surreal'], createdAt: new Date() },
    { moodId: 'mood_013', name: 'Mysterious', description: 'Geheimnisvolle, rätselhafte Stimmung', keywords: ['enigmatic', 'cryptic', 'puzzling'], createdAt: new Date() },
    ...
    { moodId: 'mood_015', name: 'Powerful', description: 'Kraftvolle, mächtige Klänge', keywords: ['strong', 'mighty', 'commanding'], createdAt: new Date() },
    ...
    { moodId: 'mood_017', name: 'Chill', description: 'Entspannt und cool', keywords: ['cool', 'relaxed', 'smooth'], createdAt: new Date() },
    { moodId: 'mood_018', name: 'Sunny', description: 'Sonnige Stimmung', keywords: ['sun', 'warm', 'bright'], createdAt: new Date() },
    { moodId: 'mood_019', name: 'Epic', description: 'Episch und groß', keywords: ['grand', 'monumental', 'heroic'], createdAt: new Date() },
